...
public class TestFrancoHegele {
	...
	public static void main(String[] args) {
		...
		Cajero cajero1 = abm.traerCajeroQueMasRecaudoEntreFechas(LocalDate.of(2026, 9, 5), LocalDate.of(2026, 9, 5));
		...
		Cajero cajero2 = abm.traerCajeroQueMasRecaudoEntreFechas(LocalDate.of(2026, 9, 5), LocalDate.of(2026, 9, 6));
		...
		Cajero cajero3 = abm.traerCajeroQueMasRecaudoEntreFechas(LocalDate.of(2026, 9, 5), LocalDate.of(2026, 9, 7));
		...
		Cajero cajero4 = abm.traerCajeroQueMasRecaudoEntreFechas(LocalDate.of(2026, 9, 1), LocalDate.of(2026, 9, 30));
